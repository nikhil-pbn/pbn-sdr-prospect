...
/**
 * shadcn's sonner wrapper (`npx shadcn add sonner`) with the same additions PbN
 * Proposals makes: richColors and the per-type toast tokens from tokens-*.css.
 */
      ...
      style={
        {
          ...
          // Per-type colours, defined in tokens-*.css so light and dark both work.
